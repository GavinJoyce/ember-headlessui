...
export default class ListboxComponent extends Component {
  ...
  registerOptionElement(optionComponent, optionElement) {
    ...
    // Need to schedule this to run after render. If not, you get an error that
    // says:
    //
    // Attempted to rerender, but the Ember application has had an unrecoverable
    // error occur during render. You should reload the application after fixing
