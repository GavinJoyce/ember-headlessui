...
var t,n,r,i=b(a)
function a(){var e
m(this,a),h(_(e=i.apply(this,arguments)),"dialogStackProvider",f,_(e)),w(_(e),"DEFAULT_TAG_NAME","div"),w(_(e),"guid","".concat((0,o.guidFor)(_(e)),"-headlessui-dialog")),w(_(e),"$portalRoot",T()),w(_(e),"handleEscapeKey",(0,l.modifier)((function(e,t){var n=p(t,2),r=n[0],i=n[1],o=function(e){e.key===s.Keys.Escape&&r&&(e.preventDefault(),e.stopPropagation(),i())}
...
if("boolean"!==(0,u.typeOf)(n))throw new Error("You provided an `isOpen` prop to the `Dialog`, but the value is not a boolean. Received: ".concat(n))
if("function"!==(0,u.typeOf)(r))throw new Error("You provided an `onClose` prop to the `Dialog`, but the value is not a function. Received: ".concat(r))
return e}return t=a,(n=[{key:"tagName",get:function(){return this.args.as||this.DEFAULT_TAG_NAME}},{key:"overlayGuid",get:function(){return"".concat(this.guid,"-overlay")}},{key:"titleGuid",get:function(){return"".concat(this.guid,"-title")}},{key:"descriptionGuid",get:function(){return"".concat(this.guid,"-description")}},{key:"onClose",value:function(){this.dialogStackProvider.hasOpenChild(this)||this.args.onClose()}}])&&v(t.prototype,n),r&&v(t,r),a}(r.default),f=E(c.prototype,"dialogStackProvider",[a.inject],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),E(c.prototype,"onClose",[i.action],Object.getOwnPropertyDescriptor(c.prototype,"onClose"),c.prototype),c)
