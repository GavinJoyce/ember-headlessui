...
var t,n,r,i=v(a)
function a(e,t){var n,r,c,d,h,m;(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")})(this,a),n=i.call(this,e,t),r=b(n),c="dialogStackProvider",d=f,h=b(n),d&&Object.defineProperty(r,c,{enumerable:d.enumerable,configurable:d.configurable,writable:d.writable,value:d.initializer?d.initializer.call(h):void 0}),_(b(n),"DEFAULT_TAG_NAME","div"),_(b(n),"guid","".concat((0,o.guidFor)(b(n)),"-headlessui-dialog")),_(b(n),"$portalRoot",(m={}.rootElement)?document.querySelector(m):document.body),_(b(n),"outsideClickedElement",null),_(b(n),"handleEscapeKey",(0,l.modifier)((function(e,t){var n=p(t,2),r=n[0],i=n[1],o=function(e){e.key===s.Keys.Escape&&r&&(e.preventDefault(),e.stopPropagation(),i())}
return window.addEventListener("keyup",o),function(){window.removeEventListener("keyup",o)}})))
var v=n.args,y=v.isOpen,g=v.onClose
if(void 0===y&&void 0===g)throw new Error("You have to provide an `isOpen` and an `onClose` prop to the `Dialog` component.")
if(void 0===y)throw new Error("You provided an `onClose` prop to the `Dialog`, but forgot an `isOpen` prop.")
if(void 0===g)throw new Error("You provided an `isOpen` prop to the `Dialog`, but forgot an `onClose` prop.")
if("boolean"!==(0,u.typeOf)(y))throw new Error("You provided an `isOpen` prop to the `Dialog`, but the value is not a boolean. Received: ".concat(y))
if("function"!==(0,u.typeOf)(g))throw new Error("You provided an `onClose` prop to the `Dialog`, but the value is not a function. Received: ".concat(g))
...
e.default=E,(0,t.setComponentTemplate)(w,E)})),define("ember-headlessui/components/dialog/-description",["exports","@ember/component","@ember/template-factory","@glimmer/component","ember-modifier"],(function(e,t,n,r,i){"use strict"
function o(e,t){return function(e){if(Array.isArray(e))return e}(e)||function(e,t){var n=null==e?null:"undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"]
if(null==n)return
var r,i,o=[],a=!0,u=!1
try{for(n=n.call(e);!(a=(r=n.next()).done)&&(o.push(r.value),!t||o.length!==t);a=!0);}catch(s){u=!0,i=s}finally{try{a||null==n.return||n.return()}finally{if(u)throw i}}return o}(e,t)||function(e,t){if(!e)return
