/*! For license information please see chunk.143.b66c3b174e16b0e35bda.js.LICENSE.txt */
...
return!o||o===e}(e)}(t)||i(t)<0)},f=r.concat("iframe").join(","),d=function(e,t){if(t=t||{},!e)throw new Error("No node provided")
return!1!==a.call(e,f)&&s(t,e)}
...
return e},S=function(){if(s.tabbableGroups=s.containers.map((function(e){var t,n,r,c,s,f,d,p=(n=[],r=[],(c=e,s=(t=t||{}).includeContainer,f=l.bind(null,t),d=Array.prototype.slice.apply(c.querySelectorAll(o)),s&&a.call(c,o)&&d.unshift(c),d.filter(f)).forEach((function(e,t){var o=i(e)
...
else if(e.shiftKey){var o=h(s.tabbableGroups,(function(e){var n=e.firstTabbableNode
return t===n}))
if(o<0&&s.tabbableGroups[r].container===t&&(o=r),o>=0){var a=0===o?s.tabbableGroups.length-1:o-1
n=s.tabbableGroups[a].lastTabbableNode}}else{var i=h(s.tabbableGroups,(function(e){var n=e.lastTabbableNode
return t===n}))
...
o||S(),s.active=!0,s.paused=!1,s.nodeFocusedBeforeActivation=r.activeElement,t&&t()
var a=function(){o&&S(),A(),n&&n()}
...
t&&t()
var a=f(e,"returnFocus","returnFocusOnDeactivate"),i=function(){y((function(){a&&T(N(s.nodeFocusedBeforeActivation)),r&&r()}))}
return a&&o?(o(N(s.nodeFocusedBeforeActivation)).then(i,i),this):(i(),this)},pause:function(){return s.paused||!s.active||(s.paused=!0,I()),this},unpause:function(){return s.paused&&s.active?(s.paused=!1,S(),A(),this):this},updateContainerElements:function(e){var t=[].concat(e).filter(Boolean)
return s.containers=t.map((function(e){return"string"==typeof e?r.querySelector(e):e})),s.active&&S(),this}}).updateContainerElements(e),n}},805:function(e,t,n){var r,o
e.exports=(r=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return 1===arguments.length?o("_eai_dyn_"+e):o("_eai_dynt_"+e)(Array.prototype.slice.call(arguments,1))},window.emberAutoImportSync=function(e){return o("_eai_sync_"+e)(Array.prototype.slice.call(arguments,1))},void r("focus-trap",[],(function(){return n(564)})))},951:function(e,t){window._eai_r=require,window._eai_d=define}},t={}
function n(r){var o=t[r]
if(void 0!==o)return o.exports
var a=t[r]={exports:{}}
return e[r].call(a.exports,a,a.exports,n),a.exports}n.d=function(e,t){for(var r in t)n.o(t,r)&&!n.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},n.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},n(951)
var r=n(805)
